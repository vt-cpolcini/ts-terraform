  ...
  >
    <Flex sx={{alignItems: 'center'}}>
      ...
      <Link to="/" sx={{variant: 'links.nav'}}>
        <img src={logo} width="48" sx={{verticalAlign: 'middle', marginRight: '1em'}} alt="ts-terraform Logo" />
        ts-terraform
      </Link>
    </Flex>
    <Flex>
      ...
      <Flex>
        <NavLink href="https://github.com/ts-terraform/ts-terraform">
          <svg
            sx={{verticalAlign: 'middle', marginRight: '4px', marginTop: '-2px', height: '1.25em'}}
            height="32"
            viewBox="0 0 16 16"
            version="1.1"
            aria-hidden="true"
